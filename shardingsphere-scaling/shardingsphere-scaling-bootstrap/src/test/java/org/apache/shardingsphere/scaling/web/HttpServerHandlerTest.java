...
public class HttpServerHandlerTest {
    ...
    public void assertChannelReadStartSuccess() {
        ...
        scalingConfiguration.getRuleConfiguration().getDestinationDataSources().setSourceDatasource("jdbc:h2:mem:test_db;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false;MODE=MySQL");
